...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-white text-zinc-950">
      ...
      {/* Win */}
      <section id="win" className="scroll-mt-60 mx-auto max-w-6xl px-6 py-16 md:py-20">
      ...
      {/* Compare */}
      <section id="compare" className="scroll-mt-60 border-y border-zinc-200 bg-zinc-50">
      ...
      {/* Flow */}
      <section id="flow" className="scroll-mt-60 mx-auto max-w-6xl px-6 py-16 md:py-20">
      ...
      {/* Pricing */}
      <section id="pricing" className="scroll-mt-60 border-t border-zinc-200 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
